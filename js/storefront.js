...
(function () {
            ...
            html += `
                <div class="product-card">
                    <div class="product-card-image-wrap">
                        <img src="${window.NSBM.getProductImageUrl(product.image)}" alt="${product.name.replace(/"/g, '&quot;')}" class="product-card-image" />
    ...
    async function initProductDetailView() {
        ...
        if (imageNode) {
            imageNode.src = window.NSBM.getProductImageUrl(product.image);
        ...
        cart.forEach(item => {
            ...
            html += `
                <div style="display: flex; gap: 12px; align-items: center; border-bottom: 1px solid var(--color-outline-variant); padding-bottom: 12px; margin-bottom: 12px;">
                    <img src="${window.NSBM.getProductImageUrl(item.image)}" alt="${item.name.replace(/"/g, '&quot;')}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 6px; background-color: var(--color-surface-container-high);" />
